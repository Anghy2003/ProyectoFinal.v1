...
public class CrudProductos extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jPanel1.add(txtNombreProducto, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 70, 370, 40));
        ...
        jPanel1.add(lblPrecioProducto, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 220, -1, 40));
        ...
        jPanel1.add(lblNumeroProductos, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 320, -1, 40));
        ...
        jPanel1.add(lblDescripcion, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 120, -1, 40));
        ...
        jPanel1.add(txtDescripcion, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 120, 330, 40));
        ...
        jPanel1.add(txtExistenciaMaxima, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 360, 270, 40));
        ...
        jPanel1.add(txtProveedorID, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 270, 320, -1));
        ...
        jPanel1.add(lblExistenciaMinima1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 420, 170, 40));
        ...
        jPanel1.add(txtExistenciaMinima, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 410, 280, 40));
        ...
        jPanel1.add(lblExistenciaMinima2, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 360, -1, 40));
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        if (!txtNombreProducto.getText().trim().isBlank()) {
            if (!txtCodigoCategoria.getText().isBlank()) {
                Boolean valido = false; //creamos una bandera para validar datos

                // número con dos decimales
                if (valido = txtPrecioProducto.getText().matches("^\\d+(\\.\\d{1,2})?$")) {
                    // números
                    if (valido = txtNumeroProductos1.getText().matches("^\\d+$")) {
                ...
                JOptionPane.showMessageDialog(this, "No deje espacios en blanco en la categoría del producto");
            }
        } else {
