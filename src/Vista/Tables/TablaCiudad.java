...
public class TablaCiudad extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jPanel2.add(txtBuscarCiudad, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 90, -1, 40));
        ...
        jPanel2.add(btnAgregar, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 90, 102, -1));
        ...
        jPanel2.add(btnBuscar, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 90, 102, -1));
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        ...
        if (!txtBuscarCiudad.getText().trim().isEmpty()) {
            ...
            String BuscarCiudad = txtBuscarCiudad.getText();
            
            CrudCiudad2 mibuscarciudad = new CrudCiudad2(BuscarCiudad);
            JOptionPane.showMessageDialog(this, "Ciudad Encontrada");
            ShowpanelCruds(mibuscarciudad);
        } else {
            JOptionPane.showMessageDialog(this, "Ingrese un ID Ciudad");
        }
